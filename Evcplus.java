...
public class Evcplus {
    ...
    static int userPin = 1122;
    static final long userMobile = 619982816;
    ...
    // Keeps asking until the user types a whole number, then returns it.
    static int readInt() {
    ...
    public static void menu() {
        ...
        if (option.equals("1")) {
            ...
            System.out.println("Adeegan (Salaam Bank) hadda lama heli karo.");
            backToMenu();
        } else if (option.equals("7")) {
            maamulkaMenu();
        } else if (option.equals("8")) {
            System.out.println("Adeegan (Taaj) hadda lama heli karo.");
            backToMenu();
        } else if (option.equals("9")) {
            System.out.println("Adeegan (Bill) hadda lama heli karo.");
            backToMenu();
